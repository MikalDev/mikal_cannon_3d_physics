    ...
    Acts: {
            ...
            params: [
                {
                    id: "tag",
                    name: "Tag",
                    desc: "Tag for request (UID is appended automatically).",
                    type: "string",
                    initialValue: "",
                },
                {
                ...
                },
                {
                    id: "filterGroups",
                    name: "Filter Groups",
                    desc: "Collision filter groups (hex string).",
                    type: "string",
                    initialValue: '"0x8000"',
                },
                {
                    id: "offsetX",
                    name: "Offset X",
                    desc: "Offset X from object position.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    id: "offsetY",
                    name: "Offset Y",
                    desc: "Offset Y from object position.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    id: "offsetZ",
                    name: "Offset Z",
                    desc: "Offset Z from object position.",
                    type: "number",
                    initialValue: "0",
                },
            ],
            listName: "Raycast from self",
            displayText:
                "{my}: Raycast from self, tag {0}, to [i]{1},{2},{3}[/i], filter {4}, offset [i]{5},{6},{7}[/i]",
            description: "Cast ray from this object's position (plus optional offset) to a target point. Excludes self. Result tag has UID appended.",
        },
        CastShape: {
            category: "general",
            forward: "_CastShape",
        ...
        AttachSpring: {
            ...
            params: [
                ...
                },
                {
                    id: "localAnchorX",
                    name: "Local anchor x",
                    desc: "Anchor x on this body, relative to this body's origin.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    id: "localAnchorY",
                    name: "Local anchor y",
                    desc: "Anchor y on this body, relative to this body's origin.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    id: "localAnchorZ",
                    name: "Local anchor z",
                    desc: "Anchor z on this body, relative to this body's origin.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    ...
                    desc: "Anchor x on the target body, relative to the target body's origin.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    ...
                    desc: "Anchor y on the target body, relative to the target body's origin.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    ...
                    desc: "Anchor z on the target body, relative to the target body's origin.",
                    type: "number",
                    initialValue: "0",
                },
            ],
            ...
            displayText:
                "{my}: Attach spring {0} to uid {1}, rest length {2}, stiffness {3}, damping {4}, anchors ({5}, {6}, {7}) to ({8}, {9}, {10})",
            // The description of the action as it appears in the add action dialog
        ...
        AddSphericalJoint: {
            ...
            params: [
                {
                    id: "anchorX",
                    name: "Object Anchor Offset X",
                    desc: "Local X offset from this object's origin.",
                    type: "number",
                    initialValue: 0,
                },
                {
                    id: "anchorY",
                    name: "Object Anchor Offset Y",
                    desc: "Local Y offset from this object's origin.",
                    type: "number",
                    initialValue: 0,
                },
                {
                    id: "anchorZ",
                    name: "Object Anchor Offset Z",
                    desc: "Local Z offset from this object's origin.",
                    type: "number",
                    initialValue: 0,
                },
                {
                    id: "targetAnchorX",
                    name: "Target Anchor Offset X",
                    desc: "Local X offset from the target object's origin.",
                    type: "number",
                    initialValue: 0,
                },
                {
                    id: "targetAnchorY",
                    name: "Target Anchor Offset Y",
                    desc: "Local Y offset from the target object's origin.",
                    type: "number",
                    initialValue: 0,
                },
                {
                    id: "targetAnchorZ",
                    name: "Target Anchor Offset Z",
                    desc: "Local Z offset from the target object's origin.",
                    type: "number",
                },
                {
                    id: "targetUID",
            ...
            displayText:
                "Add {my} spherical joint to uid {6} at {0}, {1}, {2} to {3}, {4}, {5}, preserve relative position {7}",
            // The description of the action as it appears in the add action dialog
        ...
        AddRevoluteJoint: {
            ...
            params: [
                ...
                {
                    id: "contactsEnabled",
                    name: "Connected Collisions Enabled",
                    desc: "Allow the two connected bodies to collide with each other.",
                    type: "boolean",
                    initialValue: "true",
                },
                {
        ...
        SetRevoluteContactsEnabled: {
            category: "body",
            forward: "_SetRevoluteContactsEnabled",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            isAsync: false,
            ...
            listName: "Set connected-body contacts enabled",
            displayText: "{my}: Set connected-body contacts with uid {0} to {1}",
            description: "Enable or disable collisions between the two bodies connected by a revolute joint.",
        },

        AddFixedJoint: {
            category: "body",
            forward: "_AddFixedJoint",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            isAsync: false,
            params: [
                ...
                },
                {
                    id: "targetUID",
                    name: "Target UID",
                    desc: "UID of the other body connected by the joint.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    id: "contactsEnabled",
                    name: "Connected Collisions Enabled",
                    desc: "Allow collisions between the connected bodies.",
                    type: "boolean",
                    initialValue: "true",
                },
                {
                    id: "preserveRelativeRotation",
                    name: "Preserve relative rotation",
                    desc: "Keep the current rotation offset between the two bodies. Disable to align the target to this body's joint frame.",
                    type: "boolean",
                    initialValue: "true",
                },
                {
                    id: "preserveRelativePosition",
                    name: "Preserve relative position",
                    desc: "Keep the current position offset between the two bodies. Disable to use the target anchor exactly as entered.",
                    type: "boolean",
                    initialValue: "true",
                },
            ],
            listName: "Add fixed joint",
            displayText:
                "Add {my} fixed joint to uid {6} at {0}, {1}, {2} to {3}, {4}, {5}, connected collisions {7}, preserve relative rotation {8}, preserve relative position {9}",
            description: "Add a fixed joint that locks this body to a target body.",
        },

        AddPrismaticJoint: {
            category: "body",
            forward: "_AddPrismaticJoint",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            isAsync: false,
            params: [
                {
                    id: "anchorX",
                    name: "Anchor X",
                    desc: "Local anchor X on this body.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    id: "anchorY",
                    name: "Anchor Y",
                    desc: "Local anchor Y on this body.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    id: "anchorZ",
                    name: "Anchor Z",
                    desc: "Local anchor Z on this body.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    ...
                    desc: "Local anchor X on the target body.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    ...
                    desc: "Local anchor Y on the target body.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    ...
                    desc: "Local anchor Z on the target body.",
                    type: "number",
                    initialValue: "0",
                },
                {
            ...
            listName: "Add prismatic joint",
            displayText:
                "Add {my} prismatic joint to uid {9} at {0}, {1}, {2} to {3}, {4}, {5} with axis {6}, {7}, {8}, connected collisions {10}",
            description: "Add a prismatic slider joint between this body and a target body.",
        },

        AddRopeJoint: {
            category: "body",
            forward: "_AddRopeJoint",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            isAsync: false,
            params: [
                ...
                },
                {
                    id: "preserveRelativePosition",
                    name: "Preserve relative position",
                    desc: "Keep the current anchor distance by using at least the current distance as the rope length at creation time.",
                    type: "boolean",
                    initialValue: "true",
                },
            ],
            listName: "Add rope joint",
            displayText:
                "Add {my} rope joint length {0} to uid {7} at {1}, {2}, {3} to {4}, {5}, {6}, connected collisions {8}, preserve relative position {9}",
            description: "Add a rope joint that prevents two anchors from separating beyond a maximum length.",
        },

        SetPrismaticLimits: {
            category: "body",
            forward: "_SetPrismaticLimits",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            isAsync: false,
            params: [
                ...
                },
                {
                    ...
                    desc: "Minimum allowed travel along the joint axis.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    ...
                    desc: "Maximum allowed travel along the joint axis.",
                    type: "number",
                    initialValue: "100",
                },
                {
                    id: "enabled",
                    name: "Enabled",
                    desc: "Enable or disable the travel limits.",
                    type: "boolean",
                    initialValue: "true",
                },
            ],
            listName: "Set prismatic limits",
            displayText: "{my}: Set prismatic limits to uid {0}, min {1}, max {2}, enabled {3}",
            description: "Set linear travel limits on a prismatic joint.",
        },

        SetPrismaticMotor: {
            category: "body",
            forward: "_SetPrismaticMotor",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            isAsync: false,
            params: [
                ...
                },
                {
                    ...
                    desc: "Target linear velocity along the slider axis.",
                    type: "number",
                    initialValue: "0",
                },
                {
                    id: "maxForce",
                    name: "Max force",
                    desc: "Motor force coefficient. Set to 0 to disable.",
                    type: "number",
                    initialValue: "1",
                },
            ],
            listName: "Set prismatic motor",
            displayText: "{my}: Set prismatic motor to uid {0}, velocity {1}, force {2}",
            description: "Drive a prismatic joint along its axis at a target velocity.",
        },
    ...
    */
    ...
    Exps: {
        ...
        RaycastHasHit: {
            ...
            description: "1 if the raycast with the given tag hit something, otherwise 0.",
        },
        RaycastHitUID: {
            category: "general",
            forward: "_RaycastHitUID",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            returnType: "number",
            ...
            description: "UID of the object hit by the raycast, or -1 if it missed.",
        },
        RaycastDistance: {
            category: "general",
            forward: "_RaycastDistance",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            returnType: "number",
            ...
            description: "Distance from the ray origin to the hit point, or 0 if it missed.",
        },
        RaycastHitPointX: {
            category: "general",
            forward: "_RaycastHitPointX",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            returnType: "number",
            ...
            description: "World X coordinate of the raycast hit point, or 0 if it missed.",
        },
        RaycastHitPointY: {
            category: "general",
            forward: "_RaycastHitPointY",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            returnType: "number",
            ...
            description: "World Y coordinate of the raycast hit point, or 0 if it missed.",
        },
        RaycastHitPointZ: {
            category: "general",
            forward: "_RaycastHitPointZ",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            returnType: "number",
            ...
            description: "World Z coordinate of the raycast hit point, or 0 if it missed.",
        },
        RaycastHitNormalX: {
            category: "general",
            forward: "_RaycastHitNormalX",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            returnType: "number",
            ...
            description: "World X component of the raycast hit normal, or 0 if it missed.",
        },
        RaycastHitNormalY: {
            category: "general",
            forward: "_RaycastHitNormalY",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            returnType: "number",
            ...
            description: "World Y component of the raycast hit normal, or 0 if it missed.",
        },
        RaycastHitNormalZ: {
            category: "general",
            forward: "_RaycastHitNormalZ",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            returnType: "number",
            ...
            description: "World Z component of the raycast hit normal, or 0 if it missed.",
        },
        RaycastSequence: {
            category: "general",
            forward: "_RaycastSequence",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            returnType: "number",
            ...
            description: "Sequence number of the latest raycast result for the given tag.",
        },
        JointExists: {
            category: "general",
            forward: "_JointExists",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            returnType: "number",
            ...
            description: "1 if this body has a known joint connected to the given target UID, otherwise 0.",
        },
        JointType: {
            category: "general",
            forward: "_JointType",
            ...
            description: "Type of the known joint connected to the given target UID, or an empty string.",
        },
        CastShapeCurrentTag: {
            category: "general",
