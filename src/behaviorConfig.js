    ...
    */
    ...
    Acts: {
        ...
        EnableCharacterController: {
            category: "body",
            forward: "_EnableCharacterController",
            autoScriptInterface: true,
            highlight: false,
            deprecated: false,
            isAsync: false,
            params: [],
            listName: "Enable character controller",
            displayText: "{my} Enable character controller",
            // The description of the action as it appears in the add action dialog
        ...
        TranslateCharacterController: {
            ...
            displayText: "{my} Translate character controller {0}, {1}, {2}",
            // The description of the action as it appears in the add action dialog
